...
export function Footer() {
  ...
  function handleSubscribe(e: React.FormEvent) {
    ...
    // No email marketing service connected yet — this routes signups to
    // your inbox in the meantime. Swap for Mailchimp/Klaviyo/etc later.
    window.location.href = `mailto:hello@zuhairah.com?subject=${encodeURIComponent(
      "Newsletter Signup"
    )}&body=${encodeURIComponent(`Please add this email to the list: ${email}`)}`;
  }

  return (
    <footer className="relative mt-auto overflow-hidden rounded-t-[2.5rem] bg-brand-rose text-brand-cream-deep/80">
