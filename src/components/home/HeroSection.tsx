...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-brand-rose">
      <div className="grid min-h-[540px] lg:grid-cols-[0.9fr_1.1fr]">
        <div className="relative z-10 flex items-center px-6 py-16 sm:px-12 lg:px-16 xl:px-24">
          <div className="max-w-xl">
            ...
            >
              Move freely. <span className="text-brand-rose">Cover beautifully.</span>
            </h1>
            <p
        ...
        <div className="relative min-h-[330px] overflow-hidden bg-brand-rose lg:min-h-0">
          ...
          <div className="absolute inset-0 bg-brand-rose/15 mix-blend-color" />
