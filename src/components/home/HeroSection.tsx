...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-brand-cream-deep">
      <div className="grid min-h-[540px] lg:grid-cols-[0.9fr_1.1fr]">
        <div className="relative z-10 flex items-center px-6 py-16 sm:px-12 lg:px-16 xl:px-24">
          <div className="max-w-xl">
            ...
            >
              Move freely. <span className="text-brand-purple">Cover beautifully.</span>
            </h1>
            <p
            ...
            >
              <Link
                href="#shop"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-brand-purple px-7 py-3.5 text-xs font-semibold uppercase tracking-[0.14em] text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-brand-charcoal/90"
              >
                Shop the edit
